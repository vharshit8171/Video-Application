  ...
  return (
    <div className="min-h-screen text-white pt-16">
      ...
      <div className="max-w-7xl mx-auto px-1 mt-[1rem]">
        {playlists.length === 0 ? (
          <div className="flex flex-col items-center justify-center px-4 py-6 text-center opacity-80">
            <p className="text-xl mb-4">
              You haven’t created any playlists yet
            </p>
            <button
              onClick={() => setOpenCreateModal(true)}
              className="flex flex-col items-center gap-3.5 cursor-pointer px-10 py-18 border border-dashed border-white/40 rounded-xs hover:bg-white/10 transition">
              <Plus size={38} />
              <p className="text-lg font-semibold">Create your  playlist</p>
            </button>
          </div>
        ) : (
